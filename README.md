...
LibreOffice is intentionally not bundled in installers. When an Office preview needs LibreOffice and no local runtime is found, Deep AI Worker asks the user whether to download it, shows download progress, stores the runtime under the user data directory, and reloads the preview automatically after installation.
